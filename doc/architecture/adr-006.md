...
- **MsgTierUndelegate** requires exit to be triggered; after clear, the owner must call **MsgTriggerExitFromTier** again before undelegating (unless they trigger exit later).
