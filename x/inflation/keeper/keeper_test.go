...
func (s *KeeperSuite) TestInitExportGenesis_RoundTrip() {
	...
	s.Require().Equal(customParams.DecayStartHeight, exported.Params.DecayStartHeight)
...
func (s *KeeperSuite) TestInitExportGenesis_DefaultParams() {
	...
	s.Require().Equal(types.DefaultParams().DecayStartHeight, exported.Params.DecayStartHeight)
...
func (s *KeeperSuite) TestInitExportGenesis_ReImport() {
	...
	s.Require().Equal(exported1.Params.DecayStartHeight, exported2.Params.DecayStartHeight)
