{
  // WARNING: do not use these mnemonics in production
  accounts: [{
    name: 'community', // cro1kqpgwhe4qslgakplmqjmlw20d52r3dv4k8p7p8
    coins: '100cro',
    ...
    name: 'launch', // cro1drg4p8d3tgzzhp4tfn4fa3fzr4lwx270pnxfd2
    coins: '100cro',
  ...
  signers: [{
    name: 'signer1', // cro1x2szrcl765uqfttndhz27qrcjwwevs8fachle9
    coins: '10000cro',
    ...
    name: 'signer2', // cro1ya8fgd5d5ga8gpufdkem70ygx8kl47v4akas2e
    coins: '2000cro',
  ...
  reserves: [{
    name: 'reserve', // cro1ay7al3pjwsgdujjpcldpzqs3dxyn9yrka2385a
    coins: '200cro',
    mnemonic: 'key engine sunset model alarm park genre door wrong glow thumb identify depend often aspect brick cheese yard evoke dignity thing wagon fit uphold',
    vesting: '60s',
  }],
}
