...
def test_reward(cluster):
    ...
    validator3_address = cluster.address("validator", i=2)
    ...
    validator3_operator_address = cluster.address("validator", i=2, bech="val")
    ...
    old_commission_amount3 = cluster.distribution_commision(validator3_operator_address)
    ...
    old_reward_amount3 = cluster.distribution_reward(validator3_address)
    ...
    # TODO: there was one more validator added in min_self_delegation change
    # which wasn't caught as perhaps GH Actions didn't report errors?
    ...
    commission_amount3 = cluster.distribution_commision(validator3_operator_address)

    commission_amount_diff = (
        (commission_amount - old_commission_amount)
        + (commission_amount2 - old_commission_amount2)
        + (commission_amount3 - old_commission_amount3)
    )
    ...
    reward_amount3 = cluster.distribution_reward(validator3_address)

    reward_amount_diff = (
        (reward_amount - old_reward_amount)
        + (reward_amount2 - old_reward_amount2)
        + (reward_amount3 - old_reward_amount3)
    )
