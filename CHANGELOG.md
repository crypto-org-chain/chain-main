...
- [#1297](https://github.com/crypto-org-chain/chain-main/pull/1297) feat(x/tieredrewards): refactor: remove UpdateBonusCheckpoints call from AddToTierPosition and ExitDelegationFromTier. 
