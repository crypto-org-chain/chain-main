...
- [#1307](https://github.com/crypto-org-chain/chain-main/pull/1307) fix(x/tieredrewards): reject authz `MsgExec`-wrapped `MsgLockTier` and `MsgCommitDelegationToTier` from vesting accounts at checkTx.
